...
public:
    ...
    public:
        ...
        QMenu *extensions;
        Sort *sort;
        QAction *stopLoading, *sync, *quickSync, *newPlist, *loadPlist, *savePlist, *delPlist, *saveGroup, *lock, *alwaysSync, *delEntries, *delEntriesFromDisk, *delNonGroupEntries, *clear, *copy, *paste, *pasteAndPlay, *newGroup, *renameGroup, *find, *collapseAll, *expandAll, *goToPlayback, *queue, *skip, *stopAfter, *entryProperties;
    };
